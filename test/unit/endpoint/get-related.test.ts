...
describe('getRelated tests', () => {
  ...
  it('should load existing elements from the api', async () => {
    ...
    const resultPartialCollection = await getRelated(ElementUuid.ElementWithRelatedElements).then(
      (partialCollection) => {
  ...
  it('should throw detailed error when element is not found', async () => {
    ...
    await expect(getRelated(ElementUuid.NotFoundElementWithRelatedElements)).to.be.rejectedWith(
      Error,
  ...
  it('should throw detailed error when element is forbidden', async () => {
    ...
    await expect(getRelated(ElementUuid.ForbiddenElementWithRelatedElements)).to.be.rejectedWith(
      Error,
