...
const childrenHandler: RestHandler[] = [
  ...
  rest.get(`http://localhost/${ElementUuid.AuthenticatedDataNode}/children`, (_req, res, ctx) => {
    ...
    return res(
      ...
      ctx.json({
        type: '_PartialCollection',
        id: `/${ElementUuid.AuthenticatedDataNode}/children?page=1&pageSize=25`,
        totalNodes: 2,
        links: {
          first: `/${ElementUuid.AuthenticatedDataNode}/children?page=1&pageSize=25`,
          previous: null,
          next: null,
          last: `/${ElementUuid.AuthenticatedDataNode}/children?page=1&pageSize=25`,
        },
        nodes: [
          {
            type: 'Node',
