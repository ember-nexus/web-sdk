...
describe('Uuid tests', () => {
  it('should validate real uuid without problems', () => {
  ...
  it('should throw exception if token is uuid v1', () => {
  ...
  it('should throw exception if token is uuid v2', () => {
  ...
  it('should throw exception if token is uuid v3', () => {
  ...
  it('should throw exception if token is uuid v5', () => {
  ...
  it('should throw exception if token is uuid v6', () => {
  ...
  it('should throw exception if token is uuid v7', () => {
  ...
  it('should throw exception if token is uuid v8', () => {
