...
class GetRelatedEndpoint {
  ...
  async getRelated(uuid: typeof uuidv4, page = 1, pageSize: null | number = null): Promise<PartialCollection> {
    uuid = uuid.toString();
    if (pageSize === null) {
    ...
    return new Promise((resolve, reject) => {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.logger.debug(`Loaded related elements to node with identifier ${uuid}.`, {
            page: page,
            pageSize: pageSize,
...
export default GetRelatedEndpoint;
