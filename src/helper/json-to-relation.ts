...
export async function jsonToRelation(data: any): Promise<Relation> {
  return new Promise(function (resolve, reject) {
    ...
    if (!data.hasOwnProperty('start')) {
      reject(
        new Error("Data object does not contain property with name 'start'"),
      );
    }
    if (!data.hasOwnProperty('end')) {
      reject(
        new Error("Data object does not contain property with name 'end'"),
      );
    }
    if (!data.hasOwnProperty('data')) {
      reject(
        new Error("Data object does not contain property with name 'data'"),
      );
    }
